...
export interface ApiAboutSchoolAboutSchool extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    video: Schema.Attribute.Component<'shared.you-tube-player-slice', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    EmploymentStatistics: Schema.Attribute.Component<
      'shared.employment-statistics',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    applicationsAtUniversity: Schema.Attribute.Component<
      'shared.applications-at-university',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    euProjects: Schema.Attribute.Component<'entries.eu-project-entry', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiFestivalFestival extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    content: Schema.Attribute.Component<'shared.text-with-image', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    winners: Schema.Attribute.Component<'shared.festival-winners', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    prizes: Schema.Attribute.Component<'shared.prizes', false> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiFieldOfStudyFieldOfStudy
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    galleries: Schema.Attribute.Component<'shared.gallery', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    contact: Schema.Attribute.Component<'shared.rich-text-with-title', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    instagram: Schema.Attribute.Component<
      'navigation.conditional-external-link',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    facebook: Schema.Attribute.Component<
      'navigation.conditional-external-link',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
    ...
    youtube: Schema.Attribute.Component<
      'navigation.conditional-external-link',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
...
export interface ApiGalleryUatGalleryUat extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    image_424x488: Schema.Attribute.Media<'images' | 'files'> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    text_with_image: Schema.Attribute.Component<
    ...
    fields_of_studies: Schema.Attribute.Component<'entries.study-entry', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    festivals: Schema.Attribute.Component<'entries.festival-entry', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    galleries: Schema.Attribute.Component<'entries.gallery', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    video_with_text: Schema.Attribute.Component<
      'shared.video-with-text-slice',
      false
    > &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
...
export interface ApiMenuApplicantMenuApplicant extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    bottomLeftLink: Schema.Attribute.Component<
      'navigation.conditional-internal-link',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    bottomRightLink: Schema.Attribute.Component<
      'navigation.conditional-internal-link',
      false
    > &
      Schema.Attribute.Required &
    ...
    studies: Schema.Attribute.Component<'entries.study-entry', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiMenuFestivalMenuFestival extends Struct.SingleTypeSchema {
...
export interface ApiMenuSchoolMenuSchool extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    news: Schema.Attribute.Component<
      'navigation.conditional-internal-link',
      false
    > &
      Schema.Attribute.Required &
...
export interface ApiMenuStudentMenuStudent extends Struct.SingleTypeSchema {
...
export interface ApiNewsEntryNewsEntry extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    important_news: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    facebook_id: Schema.Attribute.String &
      Schema.Attribute.Private &
      Schema.Attribute.Unique &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiTeacherTeacher extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    extra_role: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    photo_340x609: Schema.Attribute.Media<'images'> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
